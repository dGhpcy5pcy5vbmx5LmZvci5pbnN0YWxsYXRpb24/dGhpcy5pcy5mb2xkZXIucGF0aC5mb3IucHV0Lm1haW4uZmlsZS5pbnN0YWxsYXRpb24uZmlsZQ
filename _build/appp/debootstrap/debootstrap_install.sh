...
# for debootstrap dont support multiple mirror sources when we need apply security updates
# hardcoded atm
#echo -e "deb $repo_url $DIST main" > "/etc/apt/sources.list"
#echo "deb $repo_url $DIST-updates main" >> "/etc/apt/sources.list"
#echo "deb $sec_repo_url $DIST-security main" >> "/etc/apt/sources.list"
#apt-get update
echo "debootstraped"
