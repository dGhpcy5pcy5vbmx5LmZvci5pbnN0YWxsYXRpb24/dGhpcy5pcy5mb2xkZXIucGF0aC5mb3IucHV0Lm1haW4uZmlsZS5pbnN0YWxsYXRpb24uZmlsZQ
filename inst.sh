...
[[ "$tmpTARGETMODE" != "1" ]] && [[ "$tmpTARGETMODE" != '4' ]] && [[ "$tmpTARGETMODE" != '5' ]] && {
  printf "\n ✔ %-30s" "Copying vmlinuz ......" && [[ "$tmpBUILD" != "1" ]] && { [[ -d $instto ]] && cp -f $topdir/$downdir/debianbase/vmlinuz$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64) $instto/vmlinuz_1kddinst && echo -en "[ \033[32m done. \033[0m ]"; } || { cp -f $topdir/$downdir/debianbase/vmlinuz$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64) $topdir/$remasteringdir/boot/vmlinuz_1kddinst && echo -en "[ \033[32m done. \033[0m ]"; }
  sleep 2 && printf "\n ✔ %-30s" "Copying initrfs ......" && [[ "$tmpBUILD" != "1" ]] && { [[ -d $instto ]] && cp -f $topdir/$downdir/debianbase/initrfs$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64).img $instto/initrfs_1kddinst.img && echo -en "[ \033[32m done. \033[0m ]"; } || { cp -f $topdir/$downdir/debianbase/initrfs$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64).img $topdir/$remasteringdir/boot/initrfs_1kddinst.img && echo -en "[ \033[32m done. \033[0m ]"; }
